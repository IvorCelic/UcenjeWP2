...
export default function Smjerovi() {
    ...
    function verificiran(smjer) {
        ...
        if (smjer.verificiran == true) return 'green';
        return 'red';
    }

    function verificiranTitle(smjer) {
        if (smjer.verificiran == null) return 'Nije definirano';
        if (smjer.verificiran == true) return 'Verificiran';
                ...
                <tbody>
                    {smjerovi && smjerovi.map((smjer, index)=>(
                        <tr key = {index}>
                            ...
                            <td className={smjer.cijena == null ? 'sredina' :
                            'desno'}>
                                {smjer.cijena == null
                                ? 'Nije definirano'
                                : 
                            ...
                            <td className={smjer.upisnina == null ? 'sredina' :
                            'desno'}>
                                {smjer.upisnina == null
                                ? 'Nije definirano'
                                :
